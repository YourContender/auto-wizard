...
export const configService = [
	...
	},
	{
		...
		description:
			"З кожним роком автомобілі стають більш технологічними та складними у будові. Визначити причину несправності без спеціального обладнання неможливо. Для швидкої та ефективної перевірки несправностей СТО «Вован» пропонує клієнтам комп’ютерну діагностику. Це один із найбільш швидких та точних способів виявлення поломок. Також цей вид діагностики дозволяє запобігти розвитку несправності в майбутньому. Діагностика автомобілів марки Mercedes виконується за допомогою автосканера Star Diagnosis SDConnect 4. Чекаємо на вас за адресою: м. Київ, вул. Постова, 64 (мкр. Відрадний).",
	},
	{
		types: "diagnostics",
		...
		description:
			"Ходова частина сучасного авто включає безліч важелів, шарнірів, укомплектована датчиками та допоміжними системами. Зважаючи на складну конструкцію, якісно продіагностувати її стан можливо тільки в умовах СТО.Фахівці СТО «Вован» допоможуть визначити будь-яку несправність та оцінити зношування кожного елемента підвіски. Також наші майстри роблять якісний ремонт ходової частини авто будь-якої складності. Чекаємо на вас за адресою: м. Київ, вул. Постова, 64 (мкр. Відрадний).",
	},
	{
		types: "diagnostics",
		...
		description:
			"Трансмісія служить для передачі крутного моменту від ДВС на провідні колеса. КПП зазнає великих навантажень, особливо при експлуатації авто в місті. Потрібно розуміти, що коробка передач не виходить з ладу відразу. Водій може не підозрювати про несправність, експлуатуючи авто далі. Це може призвести до підвищеного зносу інших елементів трансмісії, що тягне вже на дорожчий ремонт. Вчасно виконавши діагностику, можна зберегти коробку та заощадити великі гроші на ремонті КПП. СТО «Вован» пропонує своїм клієнтам діагностику механічних та автоматичних коробок авто будь-яких марок. Чекаємо на вас за адресою: м. Київ, вул. Постова, 64 (мкр. Відрадний).",
	},
	{
		types: "diagnostics",
		...
		description:
			"Комплексна комп'ютерна діагностика автомобіля перед придбанням допомагає уникнути багатьох проблем і несподіваних витрат у майбутньому. Вона дозволяє виявити приховані дефекти, оцінити технічний стан автомобіля та прийняти обґрунтоване рішення про покупку. Це інвестиція у Ваш спокій та безпеку на дорозі.",
	},
	{
		types: "repair",
		path: "/repair/palivna-sistema",
		...
		description:
			"Стабільну роботу двигуна не можна гарантувати без хорошого палива. На жаль, багато вітчизняних АЗС нехтують якістю пального, через що автовласники стикаються з несправністю паливних систем. Необхідно знати, що від стану паливної системи істотно залежать як експлуатаційні характеристики (динаміка і витрата), так й ресурс двигуна загалом. Фахівці СТО «Вован» рекомендують проводити регулярну діагностику, обслуговування та ремонт паливних систем. Вклавши невелику суму, ви зможете заощадити на ремонті двигуна надалі. Чекаємо на вас за адресою: м. Київ, вул. Постова, 64 (мкр. Відрадний).",
	},
	{
		types: "repair",
		...
		description:
			"Вихлопна система являє собою складну магістраль, яка включає колектор, каталізатори, датчики, резонатор і глушник. Їхня робота спрямована на зниження рівня шумності та токсичності відпрацьованих газів. Часто власники не приділяють уваги вихлопній системі. Адже від її стану залежить багато факторів, у тому числі потужність та витрата палива. СТО «Вован» здійснює весь спектр робіт з діагностики та ремонту вихлопних систем вітчизняних авто та іномарок, у т.ч. видалення/заміна каталізатора та сажового фільтра. Ми використовуємо тільки якісні запчастини, а також гарантуємо якість роботи. Чекаємо на вас за адресою: м. Київ, вул. Постова, 64 (мкр. Відрадний).",
	},
];
